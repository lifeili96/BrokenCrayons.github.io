...
date:       2018-12-07
author:     Jiawen Wu
header-img: img/post-bg-excelbubble.png
catalog: true
tags:
    - 统计软件应用
---
...
### STEP2 创建旋转矩阵M，得到旋转后坐标矩阵 <a href="https://www.codecogs.com/eqnedit.php?latex=A^{*}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?A^{*}" title="A^{*}" /></a>
